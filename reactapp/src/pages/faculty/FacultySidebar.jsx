...
export default function FacultySidebar() {
  ...
  const menuItems = [
    { label: "Dashboard", icon: <DashboardIcon />, path: `/faculty/dashboard/${username}` },
    { label: "Manage Courses", icon: <SchoolIcon />, path: `/faculty/manage-courses/${username}` },
    { label: "Assign Grades", icon: <GradeIcon />, path: `/faculty/assign-grades/${username}` },  ];
