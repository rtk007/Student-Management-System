...
public class AuthController {
    ...
    // Registration endpoint is disabled as users are created via bulk upload by Admin.
    /*
    ...
    */
    ...
    public Object updatePassword(@RequestBody Map<String, String> request) {
        try {
            ...
            if (username == null || oldPassword == null || newPassword == null) {
                return Map.of("error", "Username, old password, and new password are required");
            }
            ...
            return Map.of("error", "Password update failed: " + e.getMessage());
        }
    }
